...
module NavbarHelper
  ...
  def menu_item(name=nil, path="#", *args, &block)
    ...
    content_tag :li, :class => "#{is_active?(path, options)} #{options[:class]}" do
  ...
  def drop_down_header(text)
    content_tag :li, text, :class => "navbar-header"
  end
  ...
  def responsive_div(&block)
    content_tag(:div, ul_wrapper(&block), :class => "navbar-collapse collapse")
  end

  def ul_wrapper(&block)
    content_tag(:ul, capture(&block), :class => "nav navbar-nav" )
  end
